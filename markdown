...
Syntax
Titles
Горизональные правила могут быть созданы с помощью 3 и более дефисов,звездочек или подчеркиваний в строке
...
Для выдления курсивом, слово или словосочетание нужно заключить его в звуздочки или нижнее подчеркивание, пример, и еще один пример

Для выделения жирным шрифтом, в начале и конце слова ставят по две звездочки или по два нижних подчеркивания, пример и еще один пример
...
For realization use GitHub

Синтаксис встроенного изображения такойже, но перед [] нужно поставить !, пример

see a picture

Ссылочные ссылки используют [] для текста ссылки и сопровождаются другими [], где содержится идентификатор нашего выбора. Дальше мы должны в друой отдельной строке (можем указать в любом месте документа, но чаще всего эти сноски размещают в конце документа) указать вторые [] с синтаксисом идентификатора дальше через ":" и пробел указть URL-адрес ссылки, после кторого через еще один пробел в "" может идти текст атрибута title, пример For realization use GitHub

Ссылочные изоражения добаляются по такому же синтаксису, но со знаком "!" перед первыми [], пример see a picture

Существует еще одн способ добавить ссылку, заключив ее в <>, пример For realization use https://app.pluralsight.com/player?course=writing-content-with-markdown&author=justin-schwarty&name=writing-content-with-markdown-m2&clip=2&mode=live
